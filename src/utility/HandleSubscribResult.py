...
class HandleSubscribeResult:
    ...
    @staticmethod
    def get_subscribed_result(traci, num_of_interval, current_interval):
        print("num_of_interval, current_interval", num_of_interval, current_interval)
        HandleSubscribeResult.lanes_result_handler(traci.lane.getAllSubscriptionResults(), num_of_interval,
                                                   current_interval)
